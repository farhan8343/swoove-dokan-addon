...
<form class="woocommerce-shipping-calculator" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
	...
	<section class="shipping-calculator-form" style="display:none;">
		...
		<?php endif; ?>
		<p style="display:none;" class="form-row form-row-wide" id="calc_shipping_digital_address_field">
			<input type="text" class="input-text " name="billing_digital_address" id="billing_digital_address" placeholder="Digital Address" value="<?= WC()->session->get('billing_digital_address')['billing'] ?>">		
		</p>
		<p style="display:none;" class="form-row form-row-wide" id="calc_shipping_phone_field">
			<input type="text" class="input-text " name="billing_phone" id="billing_phone" placeholder="Phone" value="<?= WC()->cart->get_customer()->get_billing_phone(); ?>">		
		</p>
		<p style="display:none;" class="form-row form-row-wide" id="calc_shipping_email_field">
			<input type="text" class="input-text " name="billing_email" id="billing_email" placeholder="Email" value="<?= WC()->cart->get_customer()->get_billing_email(); ?>">		
		</p>
